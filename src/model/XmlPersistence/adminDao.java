...
public class adminDao {
    ...
    public adminDao() throws SAXException, ParserConfigurationException{
        try {
            DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
            
            DocumentBuilder db = dbf.newDocumentBuilder();
            
            doc = db.parse("src/Database/admins.xml");
    ...
    private void write() throws TransformerConfigurationException, TransformerException{
        try {
            ...
            StreamResult result = new StreamResult(new FileWriter("src/Database/admins.xml"));
