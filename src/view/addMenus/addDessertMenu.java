 ...
 * @author SAMIR
 */
public class addDessertMenu extends javax.swing.JPanel implements Scrollable,ActionListener {
    ...
    public addDessertMenu(Cart cart) {
        try {
            initComponents();
