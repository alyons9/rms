...
public static JLabel grabTotal;
public static JLabel grabName;
public static JLabel grabNumber;
public static JLabel grabType;
public static JLabel grabCity;
public static JLabel grabState;
public static JLabel grabCountry;
...
ActionListener paymentConfirmListener = new ActionListener(){
      ...
      int paymentPane = JOptionPane.showConfirmDialog(
        ...
        if (paymentPane == JOptionPane.YES_OPTION) {
            ...
            add(name);
            grabName = new JLabel(nameField.getText().trim());
            ...
            add(grabName);
            grabType = new JLabel(cardType.getSelectedItem().toString());
            ...
            add(grabType);
            grabNumber = new JLabel(numberField.getText().trim());
            ...
            add(grabNumber);
            grabMonth = new JLabel(expMonth.getSelectedItem().toString() + "/" + expYear.getSelectedItem().toString()); 
            ...
            add(grabMonth);
            grabStreet = new JLabel(streetField.getText().trim()); 
            ...
            add(grabStreet);
            grabCity = new JLabel(cityField.getText().trim()); 
            ...
            add(grabCity);
            grabState = new JLabel(stateslist.getSelectedItem().toString() + " " + zipField.getText().trim()); 
            ...
            add(grabState);
            grabCountry = new JLabel(countrieslist.getSelectedItem().toString()); 
            ...
            add(grabCountry);
            grabEmail = new JLabel(emailField.getText().trim()); 
           ...
           // grabFood.setSize(200,400);
            ...
            grabTotal = new JLabel("Total: $" + RMSGui.cart.getTotal());
...
ActionListener exitListener = new ActionListener(){
    ...
    cardNumber.setVisible(false);
    card.setVisible(false);
    grabTotal.setVisible(false);
    grabEmail.setVisible(false);
    grabState.setVisible(false);
    grabCity.setVisible(false);
    grabName.setVisible(false);
    grabType.setVisible(false);
    grabNumber.setVisible(false);
    grabMonth.setVisible(false);
    name.setVisible(false);
    grabCountry.setVisible(false);
    grabStreet.setVisible(false);
    receiptSlip.setVisible(false);
