 ...
 * @author SAMIR
 */
public class changeDrinkPrice extends JInternalFrame {//being
    ...
    public changeDrinkPrice(final DrinksDao list, final JPanel panel,final String foodName) throws SAXException, ParserConfigurationException {//begin constructor
            ...
            public void actionPerformed(ActionEvent e) {
              //System.out.print(getRemoveName());
                ...
                System.out.println(""+succeeded);
                    if(succeeded==true){
                        JOptionPane.showMessageDialog(changeDrinkPrice.this,
                    ...
                    try {
                        ...
                        Logger.getLogger(changeDrinkPrice.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        adminLogInDialog.drinksEditPane.revalidate();
                         ...
                         JOptionPane.showMessageDialog(changeDrinkPrice.this, "PROBLEM CHANGING PRICE",
