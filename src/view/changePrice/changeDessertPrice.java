 ...
 * @author SAMIR
 */
public class changeDessertPrice extends JInternalFrame {//being
    ...
    public changeDessertPrice(final DessertDao list, final JPanel panel,final String foodName) throws SAXException, ParserConfigurationException {//begin constructor
            ...
            public void actionPerformed(ActionEvent e) {
              //System.out.print(getRemoveName());
                ...
                System.out.println(""+succeeded);
                    if(succeeded==true){
                        JOptionPane.showMessageDialog(changeDessertPrice.this,
