...
public class addItemToDrinkMenu extends javax.swing.JPanel {
    ...
    public addItemToDrinkMenu() throws SAXException, ParserConfigurationException {
        initComponents();
        setVisible(true);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     list.addDrink(getItemName(),getItemDescriptionName(), 1,getItemPrice(),getPictureName());
