...
import view.changePrice.changeLunchPrice;
...
import view.removeMenuItem.removeLunchItemDialog;

/**
 *
 * @author SAMIR
 */
public class adminEditLunchMenu extends javax.swing.JPanel implements ActionListener {
    ...
    private String list[];
    private LunchDao secList;
    public JPanel dialog;
    /** Creates new form addAppetizerMenu */
    public adminEditLunchMenu () throws SAXException, ParserConfigurationException {
    ...
    public void setUpComponents() throws SAXException, ParserConfigurationException{
       ...
       sizeOfList = nodeList.length();
        ...
        food = nodeList.getVectorAllLunches();
...
//          add(dialog);
            ...
            changeLunchPrice price = null;
            try {
                LunchDao secList2 = new LunchDao();
                price = new changeLunchPrice(secList2,this, aCommand);
                repaint();
            } catch (SAXException ex) {
                Logger.getLogger(adminEditLunchMenu.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ParserConfigurationException ex) {
                Logger.getLogger(adminEditLunchMenu.class.getName()).log(Level.SEVERE, null, ex);
            }
