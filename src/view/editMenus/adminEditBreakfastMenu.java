 ...
 * @author SAMIR
 */
public class adminEditBreakfastMenu extends javax.swing.JPanel implements ActionListener {
    ...
    private String list[];
    private BreakfastDao secList;
    public JPanel dialog;
    /** Creates new form addAppetizerMenu */
    public adminEditBreakfastMenu () throws SAXException, ParserConfigurationException {
    ...
    public void setUpComponents() throws SAXException, ParserConfigurationException{
       ...
       sizeOfList = nodeList.length();
        ...
        food = nodeList.getVectorAllBreakfasts();
