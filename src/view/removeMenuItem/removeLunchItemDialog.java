 ...
 * @author SAMIR
 */
public class removeLunchItemDialog extends JInternalFrame {//being
    ...
    public removeLunchItemDialog(final LunchDao list, final JPanel panel, String aCommand) throws SAXException, ParserConfigurationException {//begin constructor
        ...
        ActionListener confirmButtonAction = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              //System.out.print(getRemoveName());
                succeeded =false;
                succeeded = list.removeLunchByName(getRemoveName());
                System.out.println(""+succeeded);
                
                    adminLogInDialog.lunchMenu.removeAll();
                
                    if(succeeded==true){
                        JOptionPane.showMessageDialog(removeLunchItemDialog.this,
